...
class NestedComment(db.Model):
    ...
    comment = db.relationship('Comment', backref=db.backref('nestedComment_set'))
    content = db.Column(db.Text, nullable=False)
    created_at = db.Column(db.DateTime, nullable=False)
...
class LastComment(db.Model):
    ...
    nestedComment = db.relationship('NestedComment', backref=db.backref('lastComment_set'))
    content = db.Column(db.Text, nullable=False)
    created_at = db.Column(db.DateTime, nullable=False)
...
class OpenGraph(db.Model):
    ...
    post = db.relationship('Post', backref=db.backref('openGraph_set'))
